...
hidden1 = keras.layers.Dense(521, activation='relu')(flat)
norm3 = keras.layers.BatchNormalization(axis=-1)(hidden1)
drop3 = keras.layers.Dropout(rate=0.2)(norm3)

hidden2 = keras.layers.Dense(521, activation='relu')(drop3)
norm4 = keras.layers.BatchNormalization(axis=-1)(hidden2)
drop4 = keras.layers.Dropout(rate=0.2)(norm4)

hidden3 = keras.layers.Dense(521, activation='relu')(flat)
norm5 = keras.layers.BatchNormalization(axis=-1)(hidden3)
drop5 = keras.layers.Dropout(rate=0.2)(norm5)

out = keras.layers.Dense(2, activation='sigmoid')(drop5)
